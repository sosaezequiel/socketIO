(function (jq) {
    ...
    function _link(_element, attrs) {
        ...
        function _moduleAction(e) {//f
            switch (e) {
                ...
                case LayoutAction.LAYOUT_OVERLAY_HIDE:
                    i.trackPageView(ModulesType.REJECTED);
            }
        }
        ...
        function module_removed() {//C
            r.unsubscribeModuleAction(ModulesType.REJECTED, _moduleAction);
        ...
        function _moduleIsReady() {//b
            if (!_moduleIsReadyFlag) {
                ...
                r.moduleIsReady(ModulesType.REJECTED);
            }
        }
        ...
        function armar_columnas() {//K
            ...
            // },            
            {
                ...
                id: "nominalValue",
                name: "",
                nameKey: "REJECTED.NOMINAL_VALUE",
                i18nService: MAE.I18nService,//traductor
                field: "nominalValue",
                sortable: !0,
                ...
                cssClass: "slickgrid-cell-align-center ot-collapse",
                headerCssClass: "slickgrid-cell-align-center",
                toolTip: d.getString("REJECTED.NOMINAL_VALUE_TOOLTIP"),
                type: "number"
            }, {
                id: "comment",
                name: "",
                nameKey: "REJECTED.COMMENT",
                field: "comment",
                sortable: !0,
                cssClass: "slickgrid-cell-align-left  ot-collapse comment",
                headerCssClass: "slickgrid-cell-align-center",
                type: "string",
                width: 300,
            }, {
            ...
            var e = n.getSortData(ModulesType.REJECTED);
            ...
            n.getColumnsFromSettings(ModulesType.REJECTED, _columns);
            _xDataGridView = new XDataGridView(element.find("#rejectedGrid"));
            var container = {//r
                getter: "symbolKey",
            ...
            n.registerDatagrid(ModulesType.REJECTED, _xDataGridView.getGridView(), _columns);
            n.subscribeRefreshColumnFromSettingsEvent(refreshColumns);
            addHotkey();
            //t.setModuleValueAddHandler(ModulesType.REJECTED, "datagridColumns", setProfitMode);
            ...
            _xDataGridView.getDataModel().getItemMetadata = function (row) {
                ...
                if (dvitem != undefined) {
                    ...
                    if (dvitem.isNew == true) {
                        ...
                        class_temp = 'nuevaOrden';
                    }
                }

                return {
                    'cssClasses': class_temp,
                    'columns': {
                        "comment": {
                            "colspan": 3
                        }
        ...
        function refreshColumns() {//h
            setTimeout(function () {
                n.refreshColumns(Pe, ModulesType.REJECTED, _xDataGridView.getGridView())
            }, 0)
        }
        ...
        function unregisterDatagrid() {//G
            n.unregisterDatagrid(ModulesType.REJECTED);
            t.setModuleValueRemoveHandler(ModulesType.REJECTED, "datagridColumns", setProfitMode);
        ...
        function _moveRowCallback(e, s) {//X
            MAE.RejectedService.itemDragAndDrop(e, s);
        }
        function _headerButtonClickCallback(e, s) {//q
            "tradeTypeFilter" == s && n.showColumnFilterPopup(ModulesType.REJECTED, e, ce)
        }
        ...
        function manjear_close(s, o) {//Q
            if (s.originalEvent.target.dataset && "ordersCloseTradeBtn" == s.originalEvent.target.dataset.xsot) {
                a.logClick("openTradesModule", "ordersCloseTradeBtn"),
                    i.eventClick(ModulesType.REJECTED, "openTradesModule", "ordersCloseTradeBtn");
        ...
        function doubleUpTradeBtn_click(e, s) {//z
            a.logClick("openTradesModule", "doubleUpTradeBtn"),
                i.eventClick(ModulesType.REJECTED, "openTradesModule", "doubleUpTradeBtn"),
            ...
            o.assetClass != AssetClass.STC && m.$apply(function () {
                if ("removeSlButton" == e.originalEvent.target.id)
                    a.logClick("openTradesModule", "removeSlButton"),
                        i.eventClick(ModulesType.REJECTED, "openTradesModule", "removeSlButton"),
                    ...
                    a.logClick("openTradesModule", "sl"),
                        i.eventClick(ModulesType.REJECTED, "openTradesModule", "sl");
            ...
            o.assetClass != AssetClass.STC && m.$apply(function () {
                if ("removeTpButton" == e.originalEvent.target.id)
                    a.logClick("openTradesModule", "removeTpButton"),
                        i.eventClick(ModulesType.REJECTED, "openTradesModule", "removeTpButton"),
                    ...
                    a.logClick("openTradesModule", "tp"),
                        i.eventClick(ModulesType.REJECTED, "openTradesModule", "tp");
                    var o, l = $(e.originalEvent.target).offset(), t = s.grid.getDataItem(s.row);
                    o = $(e.originalEvent.target).hasClass("xs-ot-sltp-add-btn") ? {
                        x: l.left + 4,
                        y: l.top - 3
        ...
        function _sortCallback(e) {//ne
            ...
            n.setSortData(ModulesType.REJECTED, e.sortCol, e.sortAsc);
        }
        ...
        r.subscribeModuleAction(ModulesType.REJECTED, _moduleAction, "pendingTradesModule"),
        ...
        scope.personalizeTable = function () {
            n.showPersonalizationWindow(ModulesType.REJECTED, _xDataGridView.getGridView(), Pe, Te)
        };
    ...
    function _render(id) {
        ...
        var template = jq("#rejectedTemplate").html();
